...
namespace ApiEjemplo.Migrations
{
    ...
    [Migration("20260810010146_AddMoraCondonadaToPeriodoAmortizacion")]
    partial class AddMoraCondonadaToPeriodoAmortizacion
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ApiEjemplo.Models.CuentaAhorro", b =>
                {
                    ...
                    b.Property<DateOnly?>("fecha_ultimo_rendimiento")
                        .HasColumnType("date");
                    ...
                    b.Property<decimal>("rendimiento_acumulado")
                        .HasColumnType("decimal(12,2)");
            ...
            modelBuilder.Entity("ApiEjemplo.Models.SolicitudAprobacion", b =>
                {
                    ...
                    b.Property<DateTime?>("resuelta_at")
                        .HasColumnType("datetime(6)");

                    b.Property<int?>("resuelta_por")
                        .HasColumnType("int");

                    b.Property<int>("solicitante_id")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("solicitante_id");

                    b.HasIndex("estado", "created_at");

                    b.ToTable("solicitud_aprobacion", (string)null);
                });
            ...
            modelBuilder.Entity("ApiEjemplo.Models.SolicitudAprobacion", b =>
                {
                    ...
                    b.HasOne("ApiEjemplo.Models.Usuario", "Solicitante")
                        .WithMany()
                        .HasForeignKey("solicitante_id")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
